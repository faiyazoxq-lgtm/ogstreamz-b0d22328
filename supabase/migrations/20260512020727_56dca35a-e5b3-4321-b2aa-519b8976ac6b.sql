...
DECLARE
  ...
  -- own Swearing Agent + Chaos Mode without tripping the privileged guard.
  old_priv jsonb := old_flags - 'swearing' - 'swearing_intensity' - 'chaos_mode';
  new_priv jsonb := new_flags - 'swearing' - 'swearing_intensity' - 'chaos_mode';
BEGIN
