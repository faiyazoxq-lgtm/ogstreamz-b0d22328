...
function JokesPage() {
  ...
  const next = () => setI((p) => (p + 1) % jokes.length);
  return (
    <main className="max-w-3xl mx-auto px-5 sm:px-8 py-16 sm:py-24 min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center">
      ...
      <h1 className="font-[Montserrat] font-black text-4xl sm:text-5xl tracking-tight text-center mb-12">
        Daily <span className="text-gradient-gold">Punchlines</span>
      </h1>
      ...
      <Button
        onClick={next}
        className="mt-10 bg-gold text-primary-foreground hover:bg-gold/90 font-semibold px-10 py-6 text-base animate-pulse-gold"
      >
