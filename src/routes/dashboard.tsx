...
import { Crown, Coins, Ticket, History, Loader2, Sparkles, ExternalLink, Music, Mic2, Wrench, Flame } from "lucide-react";
...
export const Route = createFileRoute("/dashboard")({
  head: () => ({ meta: [{ title: "Syndicate Dashboard · 0G-PORTAL" }] }),
...
const RANK_META: Record<string, { label: string; color: string; perks: string }> = {
  ...
  boss: { label: "Boss", color: "text-pink-400", perks: "Spawn your own portals · All access" },
};
    ...
    <main className="relative max-w-5xl mx-auto px-5 sm:px-8 py-12">
      ...
      <section className="grid sm:grid-cols-3 gap-4 mb-10">
        ...
        <Card>
          ...
          <Link to="/store" className="mt-1 inline-block text-xs underline text-[color:var(--neon-blue-bright)]">Top up →</Link>
        </Card>
        <Card>
