...
export function ReducedMotionToggle() {
  ...
  return (
    <button
      ...
      aria-label={label}
      className="fixed bottom-20 left-3 md:bottom-3 z-[60] flex items-center gap-1.5 rounded-full border border-white/15 bg-black/55 backdrop-blur px-2.5 py-1.5 text-[11px] uppercase tracking-wider text-white/75 hover:text-white hover:bg-black/70 transition print:hidden"
    >
