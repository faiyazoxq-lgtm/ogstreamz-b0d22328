...
import { ShieldCheck, Flame, Search, Loader2, Power } from "lucide-react";
...
/**
 * Guttermouth Master Switch — civility / per-item swear-chat controls.
 * Extracted from /boss/civility so it can be rendered alongside the
 * Syndicate Protocol (OG-Mode) toggles inside the admin Global Mood section.
 */
export function CivilityPanel() {
    ...
    <div className="space-y-6">
      <div className="glass-obsidian-cmd rounded-3xl p-5 md:p-6">
        <div>
          ...
          <h3 className="syndicate-header text-xl md:text-2xl text-white/95 mt-1">Guttermouth Master Switch</h3>
          <p className="mt-2 text-sm text-white/65 max-w-2xl">
            Decide whether the foul-mouthed Guttermouth swear-chat is on by default for new portals, battles and custom hubs — and flip individual items below. Independent from the OG-Mode &amp; OG Bot toggles above.
          </p>
        </div>
      ...
      <section className="glass-obsidian-cmd rounded-3xl p-5 md:p-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h3 className="syndicate-header text-lg text-white/95">Per-item Toggles</h3>
