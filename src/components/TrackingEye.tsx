...
export function TrackingEye({
  ...
  const irisGlow = isIce
    ? bloodshot
      ? "0 0 var(--eye-glow-base, 8px) -1px oklch(0.65 0.22 25 / 0.7), 0 0 calc(var(--eye-glow-base, 8px) + var(--eye-glow, 0.35) * var(--eye-glow-spread, 18px)) -2px color-mix(in oklab, var(--eye-ice-glow-soft) calc(var(--eye-glow, 0.35) * 95%), transparent)"
      : "0 0 calc(var(--eye-glow-base, 8px) + var(--eye-glow, 0.35) * var(--eye-glow-spread, 18px)) -1px color-mix(in oklab, var(--eye-ice-glow-soft) calc(var(--eye-glow, 0.35) * 100%), transparent), 0 0 calc(var(--eye-glow-inner, 2px) + var(--eye-glow, 0.35) * var(--eye-glow-inner-spread, 6px)) color-mix(in oklab, var(--eye-ice-glow) calc(var(--eye-glow, 0.35) * 70%), transparent)"
